module StaticPagesHelper
  ...
  def projects
    ...
    [
      ["WalkTalk", "http://www.walktalk.io", "A Networking web app that matches you up with another professional for coffee during lunch time and is based on your preferences! If your preference is a designer, then that's who you'll meet.", "Functional app with users and built with Rails and React"],
      ...
      ["DevWeek16Hackathon", "http://devweek16.herokuapp.com/total_tweets", "This web app takes a twitter hashtag and scrapes tweets for hashtags and words that are most used with the initial hashtag. Won 2nd place in the Dev Week 16 Redis Labs Sponser Challenge.", "I integrated Twitter API, creating an algorithm to cache tweets into Redis, and ultimately integrating everyone's tasks and deploy the site. We won 2nd place in the Redis Challenge. "],
